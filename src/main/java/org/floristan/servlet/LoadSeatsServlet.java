 ...
 */
public class LoadSeatsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static Storage storable = null; 
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadSeatsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String musicalEvent = request.getParameter("musicalEvent");
		System.out.println(musicalEvent);
		String select = storable.getSeats(musicalEvent);
